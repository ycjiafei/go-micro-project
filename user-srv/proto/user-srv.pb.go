...
// 	protoc        v3.13.0
// source: user-srv/proto/user-srv.proto
...
func (x *UidReq) Reset() {
	*x = UidReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_user_srv_proto_user_srv_proto_msgTypes[0]
...
func (*UidReq) Descriptor() ([]byte, []int) {
	return file_user_srv_proto_user_srv_proto_rawDescGZIP(), []int{0}
}
...
var file_user_srv_proto_user_srv_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x75, 0x73, 0x65, 0x72, 0x2d, 0x73, 0x72, 0x76, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_user_srv_proto_user_srv_proto_rawDescOnce sync.Once
	file_user_srv_proto_user_srv_proto_rawDescData = file_user_srv_proto_user_srv_proto_rawDesc
)

func file_user_srv_proto_user_srv_proto_rawDescGZIP() []byte {
	file_user_srv_proto_user_srv_proto_rawDescOnce.Do(func() {
		file_user_srv_proto_user_srv_proto_rawDescData = protoimpl.X.CompressGZIP(file_user_srv_proto_user_srv_proto_rawDescData)
	})
...
func init() { file_user_srv_proto_user_srv_proto_init() }
func file_user_srv_proto_user_srv_proto_init() {
	if File_user_srv_proto_user_srv_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_user_srv_proto_user_srv_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UidReq); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_user_srv_proto_user_srv_proto_goTypes,
		DependencyIndexes: file_user_srv_proto_user_srv_proto_depIdxs,
		MessageInfos:      file_user_srv_proto_user_srv_proto_msgTypes,
	}.Build()
	File_user_srv_proto_user_srv_proto = out.File
	file_user_srv_proto_user_srv_proto_rawDesc = nil
	file_user_srv_proto_user_srv_proto_goTypes = nil
	file_user_srv_proto_user_srv_proto_depIdxs = nil
}
...
var _User_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "user-srv/proto/user-srv.proto",
}
