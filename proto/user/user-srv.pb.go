...
// 	protoc        v3.13.0
// source: proto/user/user-srv.proto
...
func (x *UserInfoReply) Reset() {
	*x = UserInfoReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_user_user_srv_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var (
	file_proto_user_user_srv_proto_rawDescOnce sync.Once
	file_proto_user_user_srv_proto_rawDescData = file_proto_user_user_srv_proto_rawDesc
)

func file_proto_user_user_srv_proto_rawDescGZIP() []byte {
	file_proto_user_user_srv_proto_rawDescOnce.Do(func() {
		file_proto_user_user_srv_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_user_user_srv_proto_rawDescData)
	})
	return file_proto_user_user_srv_proto_rawDescData
}
...
func init() { file_proto_user_user_srv_proto_init() }
func file_proto_user_user_srv_proto_init() {
	if File_proto_user_user_srv_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_user_user_srv_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_user_user_srv_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_user_user_srv_proto_goTypes,
		DependencyIndexes: file_proto_user_user_srv_proto_depIdxs,
		MessageInfos:      file_proto_user_user_srv_proto_msgTypes,
	}.Build()
	File_proto_user_user_srv_proto = out.File
	file_proto_user_user_srv_proto_rawDesc = nil
	file_proto_user_user_srv_proto_goTypes = nil
	file_proto_user_user_srv_proto_depIdxs = nil
}
...
var _User_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/user/user-srv.proto",
}
